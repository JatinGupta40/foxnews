...
/* themes/custom/foxnews/template/footer/field/field--menu-link-content--social.html.twig */
class __TwigTemplate_24a67a591edcde11a7bf709f43cdcaa78d9f37425fd4f167f41a6369b1aa2188 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 66
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 66), "addClass", [0 => "socialicon"], "method", false, false, true, 66), 66, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return "themes/custom/foxnews/template/footer/field/field--menu-link-content--social.html.twig";
    }
...
{% else %}
  <div{{ attributes }}>
    ...
    {% endif %}
    {% for item in items %}
      <div{{ item.attributes.addClass('socialicon') }}>{{ item.content }}</div>
    {% endfor %}
    {% if multiple %}
      </div>
    {% endif %}
...
{% endif %}
", "themes/custom/foxnews/template/footer/field/field--menu-link-content--social.html.twig", "/var/www/html/foxnews/web/themes/custom/foxnews/template/footer/field/field--menu-link-content--social.html.twig");
    }
