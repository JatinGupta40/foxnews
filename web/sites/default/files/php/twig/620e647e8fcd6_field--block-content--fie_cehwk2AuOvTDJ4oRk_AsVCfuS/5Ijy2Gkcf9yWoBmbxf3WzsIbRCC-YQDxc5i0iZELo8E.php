...
/* themes/custom/foxnews/template/footer/field/field--block-content--field-social-icon.html.twig */
class __TwigTemplate_baac7eeb896c0abc68842e5c521b1b147825dac712759cfba81f900499e3593b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/custom/foxnews/template/footer/field/field--block-content--field-social-icon.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div class=\"footer_icon_menu\"{{ attributes }}>
      {% for item in items %}
        <div class=\"socialicon\"{{ item.attributes }}>{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
...
{% endif %}
", "themes/custom/foxnews/template/footer/field/field--block-content--field-social-icon.html.twig", "/var/www/html/foxnews/web/themes/custom/foxnews/template/footer/field/field--block-content--field-social-icon.html.twig");
    }
