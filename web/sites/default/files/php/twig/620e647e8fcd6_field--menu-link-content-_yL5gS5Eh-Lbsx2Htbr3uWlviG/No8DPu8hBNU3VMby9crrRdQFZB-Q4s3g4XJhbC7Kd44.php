...
/* themes/custom/foxnews/template/footer/field/field--menu-link-content--footer-legal-text.html.twig */
class __TwigTemplate_e2db4f54d559e5bed9e240f4e434e788d37682ac5e7d13317e506dc7ec066a2e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
    ...
    <div";
            // line 61
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "legalTextTitle"], "method", false, false, true, 61), 61, $this->source), "html", null, true);
            echo ">";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 66
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 66), "addClass", [0 => "legalText"], "method", false, false, true, 66), 66, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return "themes/custom/foxnews/template/footer/field/field--menu-link-content--footer-legal-text.html.twig";
    }
    ...
    {
        return array (  135 => 71,  131 => 69,  128 => 68,  117 => 66,  112 => 65,  108 => 63,  106 => 62,  100 => 61,  95 => 60,  91 => 58,  82 => 56,  77 => 55,  73 => 53,  62 => 51,  58 => 50,  53 => 49,  50 => 48,  48 => 47,  45 => 46,  43 => 43,  42 => 42,);
    }
...
{% else %}
  <div{{ attributes }}>
    <div{{ title_attributes.addClass('legalTextTitle') }}>{{ label }}</div>
    {% if multiple %}
      <div>
    {% endif %}
    {% for item in items %}
      <div{{ item.attributes.addClass('legalText') }}>{{ item.content }}</div>
    {% endfor %}
    {% if multiple %}
      </div>
    {% endif %}
...
{% endif %}
", "themes/custom/foxnews/template/footer/field/field--menu-link-content--footer-legal-text.html.twig", "/var/www/html/foxnews/web/themes/custom/foxnews/template/footer/field/field--menu-link-content--footer-legal-text.html.twig");
    }
